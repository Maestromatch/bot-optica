...
const MI_OPTICA = {
  name: "Ópticas Ferreira",
  city: "Llay Llay",
  owner: "Prima Ferreira",
  ...
  return (
    <div style={{ background: C.bg, minHeight: "100vh", fontFamily: "'Inter', sans-serif", color: C.text }}>
      ...
      <div className="main-content" style={{ padding: "40px 32px", maxWidth: 1100, margin: "0 auto" }}>
        {errorStatus ? (
          <div style={{ background: "#450a0a", color: "#fecaca", padding: 24, borderRadius: 12, border: "1px solid #991b1b" }}>
            <h3 style={{ marginBottom: 8 }}>⚠️ Error en el Dashboard</h3>
            <p style={{ fontSize: 14 }}>{errorStatus}</p>
            <button onClick={() => window.location.reload()} style={{ marginTop: 16, background: "#991b1b", color: "#fff", border: "none", padding: "8px 16px", borderRadius: 6, cursor: "pointer" }}>Reintentar</button>
          </div>
        ) : loading ? (
          ...
          <Fade>
            ...
            {/* MONITOR DE COLAS (Modo Tanque Activo) */}
